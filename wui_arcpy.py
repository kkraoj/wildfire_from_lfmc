...
year = 2016
forest = os.path.join(dir_root, r"data\WUI\forest%04.tif"%year)
...
#raster to polygon
#arcpy.RasterToPolygon_conversion("%s.tif"%forestName, "%s"%forestName)
#arcpy.RasterToPolygon_conversion("%s.tif"%urbanName, "%s"%urbanName)
...
#
#print("begun")
#arcpy.conversion.PolygonToRaster(inFeature, fieldName, outRaster, "MAXIMUM_AREA",fieldName,0.035932611)
#print("done")
